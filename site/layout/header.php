...
<head>
    <title>Trang chủ - Thời trang Goda</title>
    <meta charset="utf-8">
    ...
    <header>
        ...
        <div class="top-navbar container-fluid">
            <div class="menu-mb">
                ...
                <a class="<?=in_array($routeName, ["product", "product-detail", 'search']) ? "active" : ""?>"
                    href="<?=$router->generate('product')?>">Sản phẩm</a>
                <a class="<?=$routeName == "returnPolicy" ? "active" : ""?>"
                    href="<?=$router->generate('returnPolicy')?>">Chính sách đổi trả</a>
                <a class="<?=$routeName == "paymentPolicy" ? "active" : ""?>"
                    href="<?=$router->generate('paymentPolicy')?>">Chính sách thanh toán</a>
                <a class="<?=$routeName == "deliveryPolicy" ? "active" : ""?>"
                    href="<?=$router->generate('deliveryPolicy')?>">Chính sách giao hàng</a>
                <a class="<?=$routeName == "contact-form" ? "active" : ""?>"
                    href="<?=$router->generate('contact-form')?>">Liên hệ</a>
            </div>
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 logo">
                    <a href="#"><img src="../upload/fashion_logo.jpg" class="img-responsive"></a>
                </div>
                ...
                <div class="col-lg-4 col-md-4 hotline-search">
                    <div>
                        <p class="hotline-phone"><span><strong>Hotline: </strong><a
                                    href="tel:0938.602.765">0938.602.765</a></span></p>
                        <p class="hotline-email"><span><strong>Email: </strong><a
                                    href="mailto:trinhvantrung2k1@gmail.com">trinhvantrung2k1@gmail.com</a></span></p>
                    </div>
    ...
    <nav class="navbar navbar-default desktop-menu">
        <div class="container">
            <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                ...
                <li class="<?=in_array($routeName, ["product", "product-detail", 'search'])  ? "active" : ""?>"><a
                        href="<?=$router->generate('product')?>">Sản phẩm </a></li>
                ...
                <li class="<?=$routeName == "contact-form" ? "active" : ""?>"><a
                        href="<?=$router->generate('contact-form')?>">Liên hệ</a></li>
            </ul>
            <span class="hidden-lg hidden-md experience">Trải nghiệm cùng sản phẩm của BOSS</span>
