                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-4 list">
                        <div class="footerLink">
                            ...
                            <ul class="list-unstyled">
                                <li>Phone: 0938.602.765</li>
                                <li><a href="mailto:trinhvantrung2k1@gmail.com">Mail: trinhvantrung2k1@gmail.com</a>
                                </li>
                            </ul>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" name="password_confirmation"
                            placeholder="Nhập lại mật khẩu" autocomplete="off" autosave="off">
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-color">
                ...
                <div class="text-center">
                    <a class="btn btn-primary google-login" href="<?=$loginUrl?>"><i class="fab fa-google"></i></i> Đăng
                        nhập bằng Google</a>
                    <!-- Facebook login -->
                    <?php
